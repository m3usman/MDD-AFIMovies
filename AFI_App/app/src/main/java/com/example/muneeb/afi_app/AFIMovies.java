...
public class AFIMovies {
	...
	*/
        ...
        int[] filmNumbersChosen = new int[101]; // array of numbers; // stores the selected film list numbers; // end constructor
...
// public methods
    ...
    public void chooseFilmList(){
        ...
        while (totalFilmNumbersDrawn <= 5) // loop while more film numbers to choose
        {
            ...
            filmNumbersChosen[filmNumbersIndex] = filmNumberDrawn; // Stores new file no. into array
            filmNumbersIndex = filmNumbersIndex + 1; // Passes increment to the next array element
            totalFilmNumbersDrawn = totalFilmNumbersDrawn + 1; // Increments final total of no. chosen
